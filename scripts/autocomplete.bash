...
# autocomplete.bash
# -----------------------------------------------------------------------------
# Shell completion installer for "autotarcompress"
#
...
INSTALL_DIR="${INSTALL_DIR:-$XDG_DATA_HOME/autotarcompress}"
...
LOG_DIR="$XDG_DATA_HOME/autotarcompress/logs"
readonly LOG_DIR
...
check_bash_rc_configured() {
    ...
    grep -q "autotarcompress.*bash_autocomplete" "$rc_file" 2>/dev/null && return 0
    grep -q "source.*bash/completions/autotarcompress" "$rc_file" 2>/dev/null && return 0
    grep -q "\..*bash/completions/autotarcompress" "$rc_file" 2>/dev/null && return 0
...
update_bash_completion() {
    ...
    dst="$dst_dir/autotarcompress"
    rel="bash/completions/autotarcompress"
    ...
    # Important:
    #
    # "Installed: bash/completions/autotarcompress"
    # means the actual completion file was copied to:
    #
    #   ~/.config/bash/completions/autotarcompress
    #
...
update_zsh_completion() {
    ...
    dst="$dst_dir/_autotarcompress"
    rel="zsh/_autotarcompress"
    ...
    # Important:
    #
    # "Installed: zsh/_autotarcompress"
    # means the actual completion file was copied to:
    #
    #   ~/.config/zsh/completions/_autotarcompress
    #
